...
export const WEAPONS: WeaponDef[] = [
  ...
  },
  {
    ...
    talentDesc:
      "Named ACS-12. Increased rate of fire and reduced base damage versus the standard ACS-12. No named talent — the talent slot can be recalibrated. Cannot be deconstructed.",
  },
  {
    id: "m700",
    name: "M700 Carbon",
  ...
  },
  {
    ...
    rpm: 310,
    mag: 10,
    talent: "Innate Skill Tier",
    talentDesc:
      "+1 Skill Tier while this pistol is drawn. Named KARD-45. Talent slot can be recalibrated. Former DZ exclusive.",
    extraStats: [{ stat: "skillTier", value: 1 }],
  },
  {
    id: "caretaker",
    name: "Caretaker",
  ...
  },
  {
    ...
    rpm: 650,
    mag: 25,
    talent: "Innate Optimal Range",
    talentDesc:
      "Innate 60m Optimal Range. Named Tactical UMP-45. Talent slot can be recalibrated.",
  },
  {
    id: "grown-great",
    name: "Grown Great",
  ...
  },
  {
    ...
    talent: "Modified Base Stats",
    talentDesc:
      "Named SVD with higher base damage and slower rate of fire than the standard SVD. Talent slot can be recalibrated.",
  },
  {
    id: "relic",
    name: "Relic",
